# This script generates rag_engine.py
output = r'J:\_Proiect_Nursing_training_AI\Nursing_Training_AI_App\backend\utils\rag_engine.py'
...
with open(output, 'w', encoding='utf-8') as f:
    f.write(content)
print(f'rag_engine.py saved OK ({len(content)} bytes)')
