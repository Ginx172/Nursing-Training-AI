...
def main():
    ...
    # Folosim versiunea corectă a importului pentru a evita avertismentul de depreciere
    try:
        # Încercăm să folosim versiunea nouă
        ...
        # Dacă nu este disponibilă, folosim versiunea veche
