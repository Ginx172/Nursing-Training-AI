...
output = r'J:\_Proiect_Nursing_training_AI\Nursing_Training_AI_App\backend\utils\question_generator.py'
...
with open(output, 'w', encoding='utf-8') as f:
    f.write(content)
print(f'question_generator.py saved OK ({len(content)} bytes)')
